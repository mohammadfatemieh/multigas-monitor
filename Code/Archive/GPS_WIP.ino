// VIV'S MESSAGE:
// Tested on Aug 8 and uploads successfully, but all data values in serial monitor are 0.
// Need to test with external antenna, but missing uFL to SMA adapter
// Connect GPS RX to IO16, GPS TX to IO17
